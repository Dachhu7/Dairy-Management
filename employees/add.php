...
if (isset($_POST['submitted'])) {
    ...
    $sql = "INSERT INTO `employees` ( `e_name` ,  `e_mail` , `username`, `e_pass` ,  `e_role` ,  `e_payroll_no`  ) VALUES(  '{$_POST['e_name']}' ,  '{$_POST['e_mail']}' ,'',  '{$hashed_pass}' ,  '{$_POST['e_role']}' ,  '{$_POST['e_payroll_no']}'  ) ";
