    ...
    if (isset($_POST['f_no'])) {
       ...
       $validation= validate_farmers($_POST['f_no'], $_POST['f_id'], $_POST['f_name'],$_POST['l_name'], $_POST['f_locallity'], $_POST['f_ac'], $_POST['f_phone'],$conn);
          if ($validation['valid']==TRUE ) {
              $sql = "UPDATE farmers SET  f_no =  '{$_POST['f_no']}' ,f_id =  '{$_POST['f_id']}' ,  f_name =  '{$_POST['f_name']}' , l_name =  '{$_POST['l_name']}' ,f_locallity =  '{$_POST['f_locallity']}' ,  f_ac =  '{$_POST['f_ac']}' ,  f_phone =  '{$_POST['f_phone']}'   WHERE f_no = '$f_no' ";
...
<a href='index.php' class='btn btn-primary'>Back To Listing</a>
    <form action='' method='POST' class="form-horizontal"> 
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input class="input-xlarge" type="text" placeholder="Name.." name='l_name' value='<?php echo stripslashes($row['f_name']) ?>'/> 
            </div>
        </div>
        <div class="control-group">
